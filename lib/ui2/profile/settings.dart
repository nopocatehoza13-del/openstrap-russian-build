...
class _MoreSettingsState extends State<MoreSettings> {
  ...
  Widget build(BuildContext c) {
    ...
    return MoreSettingsView(
      ...
      onToggleZoneAlert: () => app.setZoneAlertEnabled(!app.zoneAlertEnabled),
                ...
                children: [
                  ...
                  settingsGroup(c, l?.settingsGroupPreferences ?? 'Preferences', [
                    SetRow(
                      ...
                      value: settingsChoiceLabel(units, l?.localeName),
                      onTap: onCycleUnits,
                    ),
                    SetRow(
                      LucideIcons.sun,
                      ...
                      value: settingsChoiceLabel(appearance, l?.localeName),
                      ...
                      [
                        ...
                        if (prefs.waterEnabled)
                          SetRow(
                            ...
                            value: profileText(
                              c,
                              _everyLabel(prefs.waterIntervalMin),
                            ),
                            chevron: false,
                            onTap: () => set(
                              prefs.copyWith(
  ...
  Widget build(BuildContext c) {
    ...
    return EditProfileView(
      ...
      onImport: () async {
        ...
        if (changes.isEmpty) {
          return (
            l?.settingsImportNoChange(
                  snap.found.map((x) => profileText(c, x)).join(', '),
                ) ??
        ...
        return (
          l?.settingsImportUpdated(
                changes.map((x) => profileText(c, x)).join(', '),
                storeName,
              ) ??
...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  void _save() {
    ...
    final bad = [
      ...
      if (height.bad) profileText(context, _u.heightLabel),
      if (weight.bad) profileText(context, _u.weightLabel),
    ];
    if (bad.isNotEmpty) {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _text(
                    c,
                    _height,
                    profileText(c, _u.heightLabel).toUpperCase(),
                    TextInputType.number,
                  ),
                  const SizedBox(height: S.x4),
                  _text(
                    c,
                    _weight,
                    profileText(c, _u.weightLabel).toUpperCase(),
                    TextInputType.number,
                  ),
                  ..._importBlock(p, c),
                  const SizedBox(height: S.x6),
