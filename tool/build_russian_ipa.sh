...
flutter analyze --no-pub lib/ui2/familiar lib/data/imported_vitals.dart lib/data/local_repository_impl.dart lib/app.dart lib/ui2/app_shell.dart lib/ui2/screens/workout_screen.dart lib/ui2/screens/readiness_detail.dart lib/ui2/activity/day_strain.dart packages/personal_analytics lib/compute/intraday_stress_bridge.dart lib/compute/derivation_engine.dart lib/compute/onehz_pipeline.dart lib/compute/crossday_pipeline.dart lib/notify lib/state/app_state.dart lib/data/models.dart lib/data/db.dart lib/ble/ble_engine.dart
flutter test --no-pub test/intraday_stress_test.dart test/intraday_stress_repository_test.dart test/intraday_stress_ui_test.dart test/db_serve_version_and_reads_test.dart test/familiar_age_test.dart test/familiar_ui_test.dart test/familiar_import_test.dart test/manual_session_test.dart test/import_data_safety_test.dart test/ui2_sleep_detail_test.dart test/edit_profile_import_test.dart test/sleep_profile_policy_test.dart test/ui2_contrast_test.dart test/ui2_tokens_test.dart test/ui2_whoop_tokens_test.dart test/whoop_formulas_test.dart test/whoop_crossday_test.dart test/whoop_observations_test.dart test/whoop_push_test.dart test/gen5_sample_mapping_test.dart test/familiar_load_v8_test.dart test/familiar_after_sync_test.dart test/familiar_after_sync_full_import_test.dart --reporter=expanded --concurrency=1 --timeout=120s
...
mkdir -p dist
IPA="$PWD/dist/OpenStrap-Familiar-RU-0.9.31-v8.2-unsigned.ipa"
