...
flutter test --no-pub test/intraday_stress_test.dart test/intraday_stress_repository_test.dart test/intraday_stress_ui_test.dart test/db_serve_version_and_reads_test.dart test/familiar_age_test.dart test/familiar_ui_test.dart test/familiar_import_test.dart test/manual_session_test.dart test/import_data_safety_test.dart test/ui2_sleep_detail_test.dart test/edit_profile_import_test.dart test/sleep_profile_policy_test.dart test/ui2_contrast_test.dart test/ui2_tokens_test.dart test/ui2_whoop_tokens_test.dart test/whoop_formulas_test.dart test/whoop_crossday_test.dart test/whoop_observations_test.dart test/whoop_push_test.dart test/gen5_sample_mapping_test.dart test/familiar_load_v8_test.dart test/familiar_after_sync_test.dart --reporter=expanded --concurrency=1 --timeout=120s
